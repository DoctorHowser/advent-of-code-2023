...
string[] values = File.ReadAllLines("./data/Day2.txt");

int resulta = 0;
int resultb = 0;
IsGamePossible possible = new();
foreach (string value in values)
{
    var answers = possible.Solve(value);
    resulta += Int32.Parse(answers.Item1);
    resultb += Int32.Parse(answers.Item2);
